...
**Solution:** Re-read `tasks/task_plan.md` before each decision. Goals appear in the attention window.

```
Start of context: [Original goal - far away, forgotten]
...many tool calls...
End of context: [Recently read tasks/task_plan.md - gets ATTENTION!]
```
...
|------|---------|--------------|--------------|
| `tasks/task_plan.md` | Phase tracking, progress | Task start | After completing phases |
| `tasks/findings.md` | Discoveries, decisions | After ANY discovery | After viewing images/PDFs |
| `tasks/progress.md` | Session log, what's done | At breakpoints | Throughout session |
